...
#import "AddFoundDogViewController.h"
#import <Parse/Parse.h> 

@interface AddFoundDogViewController ()

@end

@implementation AddFoundDogViewController
...
- (IBAction)AddMissingDog:(id)sender {
    ...
    [image saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        ...
        if (succeeded){
            ...
            PFObject *LostDogsObject = [PFObject objectWithClassName:@"FoundDogs"];
