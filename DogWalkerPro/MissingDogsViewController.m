...
@implementation MissingDogsViewController
...
- (PFQuery *)queryForTable {
    ...
    [query whereKey:@"GeoLocation" nearGeoPoint:geoPoint withinMiles:20];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
  ...
  PFGeoPoint *current = [PFGeoPoint geoPointWithLatitude:coordinate.latitude longitude:coordinate.longitude];
    ...
    double distance = [destination distanceInMilesTo:current];
    
 
    
    NSString *realdist = [NSString stringWithFormat:@"%g",distance];
    
      NSLog(@"Distance: %@",realdist);
