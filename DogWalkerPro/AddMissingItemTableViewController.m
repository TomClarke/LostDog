//
//  AddMissingItemTableViewController.m
//  DogWalkerPro
//
...
#import "AddMissingItemTableViewController.h"
#import <Parse/Parse.h> 
@interface AddMissingItemTableViewController ()

@end

@implementation AddMissingItemTableViewController
...
- (IBAction)AddMissingDog:(id)sender {
    ...
    [image saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        ...
        if (succeeded){
            ...
            PFObject *LostDogsObject = [PFObject objectWithClassName:@"LostItems"];
            ...
            [LostDogsObject saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
                ...
                if (succeeded){
                    ...
                    [self performSegueWithIdentifier:@"AddedMissingItemSuccessful" sender:self];
                }
                else{
